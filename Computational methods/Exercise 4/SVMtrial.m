function F = SVMtrial(dataSet,diff_C,x,y,kw,Lambda)
...
%
%   Inputs:     dataSet = desired data set number
...
%     ch = input('Choose dataset: ');             % Let the user choose
    ...
    switch ch
        case 1
            ...
            title_fig = 'Typical data - RBF kernel';
        ...
        case 2
            ...
            title_fig = 'Saddle data - RBF kernel';
        ...
        case 3
            ...
            title_fig = 'Random data - RBF kernel';
...
%             y(outlr) = -y(outlr); % Outlier (this is removable)
            title_fig = 'Random ellipse data - RBF kernel';
        ...
        case 5
            ...
            y = x(:,3); x = x(:,1:2);
            title_fig = 'Spiral data - RBF kernel';
        ...
        case 6
            ...
            y = x(:,3); x = x(:,1:2);
            Lambda = zeros(size(y));
            % change Cpos & Cneg according to the input diff_C
            if nargin == 2
                Cpos = diff_C(1);
                Cneg = diff_C(2);
            end
            ...
            title_fig = 'Imbalanced and overlapped data - RBF kernel';
